gcp_project_id = "e-dialog-creative-studio"
...
firebase_site_id      = "e-dialog-creative-studio.web.app" # (Optional) Custom Firebase Hosting Site ID, defaults to the gcp_project_id
